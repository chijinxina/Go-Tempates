...
func init() {
	proto.RegisterType((*UserRequest)(nil), "clientside.stream.UserRequest")
	proto.RegisterType((*UserResponse)(nil), "clientside.stream.UserResponse")
}
...
var fileDescriptor_116e343673f7ffaf = []byte{
	...
	0xd2, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x4c, 0xce, 0xc9, 0x4c, 0xcd, 0x2b, 0x29, 0xce,
	...
	0x25, 0x8f, 0x53, 0x1e, 0xe2, 0x08, 0x0d, 0xc6, 0x24, 0x36, 0xb0, 0x7f, 0x8c, 0x01, 0x01, 0x00,
	0x00, 0xff, 0xff, 0x56, 0xd5, 0xd3, 0xad, 0xdd, 0x00, 0x00, 0x00,
}
...
func (c *userServiceClient) GetUserInfo(ctx context.Context, opts ...grpc.CallOption) (UserService_GetUserInfoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_UserService_serviceDesc.Streams[0], "/clientside.stream.UserService/GetUserInfo", opts...)
	if err != nil {
		return nil, err
	}
...
var _UserService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "clientside.stream.UserService",
